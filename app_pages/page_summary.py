...
def page_summary_body():
    ...
    st.write(
        ...
        f'but can also affect stems, flowers, and fruits. As the disease progresses, these spots '
        ...
        f'trees spread across various farms, this approach is not scalable. To overcome this challenge, the IT team '
        f'has proposed the implementation of a machine learning (ML) system that can quickly detect powdery mildew in '
        f'images of **cherry trees**. If successful, this solution could be extended to other crops.\n\n'
    )
...
st.write(
    f'## The project focuses on two key business objectives:\n\n'
